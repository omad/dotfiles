        ...
        (quote
         (("t" "Todo" entry
          ...
          ("j" "Journal" entry
           ...
           "* %?\nEntered on %U\n  %i\n  %a"))))
  (setq gravatar-base-url "https://www.gravatar.com/avatar")
